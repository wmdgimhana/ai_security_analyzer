            ...
            {loading ? (
              ...
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                  <div className=" rounded-2xl p-6 border border-[#7e4f31]/30 shadow-2xl backdrop-blur-lg bg-white/2 hover:shadow-[#dd6317]/10 hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
                    <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="backdrop-blur-lg bg-white/2 rounded-2xl p-6 border border-[#7e4f31]/30 shadow-2xl  hover:shadow-[#dd6317]/10 hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
                    <div className="flex items-center gap-3 mb-2">
                ...
                {/* Features Section */}
                <div className="backdrop-blur-lg bg-white/4 rounded-2xl p-8 border border-[#7e4f31]/30 shadow-2xl  hover:shadow-[#dd6317]/10 hover:shadow-2xl transition-all duration-500 mb-8">
                ...
                <div className="backdrop-blur-lg bg-white/4 rounded-2xl p-8 border border-[#7e4f31]/30 shadow-2xl hover:shadow-[#dd6317]/10 hover:shadow-2xl transition-all duration-500">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="p-2 bg-gradient-to-r from-[#dd6317] to-orange-500 rounded-lg">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {apiInfo?.threat_detection?.supported_threats?.map(
                      (threat, index) => (
                        <div
                          key={index}
                        ...
                        >
                          <div className="text-gray-300 poppins-medium text-sm">
                            {threat}
                          </div>
                        </div>
                      )
